...
knitr::opts_chunk$set(echo = TRUE, cache = TRUE, fig.width=10)
library(tidyverse)
library(sf)
...
For one station: 
  ...
  - Counts the number of wind from each direction from Oct-2019 to Mar-2020
  - Use a polar coordinate to turn it into a wind rose
...
Plot the wind rose for all the stations: 

- Slightly rearrange the coordinate to be multiple of 0.4 to avoid overlapping 
